...
const contracts = [
    {
        marker: "mythic-create-section-title",
        component: "MythicSectionHeading",
        owned: new Set(["mythic-font-size-body-small", "mythic-font-weight-extra-bold", "mythic-line-height-snug", "mythic-text-primary"]),
    },
    {
        marker: "mythic-create-section-description",
        component: "MythicSectionDescription",
        owned: new Set(["mythic-font-size-small", "mythic-line-height-normal", "mythic-text-secondary"]),
    },
];
...
walk(sourceRoot).forEach((filePath) => {
    ...
    traverse(ast, {
        JSXOpeningElement(elementPath) {
            ...
            edits.push({start: opening.name.end, end: opening.name.end, value: componentProp});
            edits.push({
...
console.log(`${write ? "Migrated" : "Would migrate"} ${migratedElements} section-copy contracts in ${changedFiles} files.`);
